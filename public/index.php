...
<div class="app-shell">
    <aside class="sidebar" id="sidebar">
        ...
        <nav aria-label="Principal">
            <a class="active" href="#inicio"><span aria-hidden="true">⌂</span><span>Inicio</span></a>
            <a href="#perfil"><span aria-hidden="true">◇</span><span>Mi perfil</span></a>
            <a href="#seguridad"><span aria-hidden="true">⌾</span><span>Seguridad</span></a>
    ...
    <main>
        <header class="topbar">
            ...
            <div><p class="eyebrow">Acceso autenticado</p><h1>Panel principal</h1></div>
        ...
        <section class="hero phase-two" id="inicio">
            <div>
                ...
                <a class="primary-button" href="#seguridad">Revisar seguridad <span>→</span></a>
            </div>
            <img src="assets/images/logo.svg" alt="Escudo del Sistema de Vigilancia">
        </section>

        <section class="section-head" id="perfil">
            <div><p class="eyebrow">Tu cuenta</p><h2>Resumen de acceso</h2></div>
        </section>
        ...
        <section class="security-layout" id="seguridad">
