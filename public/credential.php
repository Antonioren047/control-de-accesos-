...
ob_start();
?><!doctype html><html lang="es"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Credencial de <?=htmlspecialchars($credential['full_name'])?></title><?php if(!$isPdf):?><link rel="stylesheet" href="assets/css/styles.css"><link rel="stylesheet" href="assets/css/ui-map.css?v=1.0.0"><?php endif;?><style>
...
<?php if(!$isPdf):?><script src="assets/js/ui-map.js?v=1.0.1"></script><script src="assets/js/credential.js?v=4.0.3" defer></script><?php endif;?></body></html><?php
