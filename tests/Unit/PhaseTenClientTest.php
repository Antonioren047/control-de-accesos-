...
final class PhaseTenClientTest extends TestCase
{
 ...
 public function testPortalVigilanteIntegraNotificacionesYMetricasPropias():void{$client=file_get_contents(dirname(__DIR__,2).'/public/assets/js/guard-operation.js');self::assertStringContainsString("dataset.guardView='notificaciones'",$client);self::assertStringContainsString('/guard/notifications',$client);self::assertStringContainsString('/guard/dashboard',$client);}
}
