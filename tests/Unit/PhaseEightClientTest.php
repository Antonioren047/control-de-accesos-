...
final class PhaseEightClientTest extends TestCase
{
 ...
 public function testNavegacionReconoceEventosYNovedades():void{$client=file_get_contents(dirname(__DIR__,2).'/public/assets/js/guard-operation.js');self::assertStringContainsString("eventos:'Eventos'",$client);self::assertStringContainsString("novedades:'Novedad de turno'",$client);}
 ...
 public function testFormularioDeIncidenciaIncluyeTipoTituloComentarioYEvidencia():void{$page=file_get_contents(dirname(__DIR__,2).'/public/guard-operation.php');self::assertStringContainsString('Tipo de incidencia',$page);self::assertStringContainsString('name="title"',$page);self::assertStringContainsString('Comentario o descripción',$page);self::assertStringContainsString('data-p8-photo="event"',$page);}
}
